...
function Details(props) {
    ...
    return (
        <React.Fragment>
            <h1><u>Board Details</u></h1>
            <h3>{board.terrain} - Price: ${board.price}</h3>
            <p><em>Quantity: {board.quantity}</em></p>
            <button onClick={ props.onClickingEdit }>Update Board Group</button> <br/><br/>
            <button onClick={()=> onClickingDelete(board.id) }>Delete Board Group</button><br/><br/>
